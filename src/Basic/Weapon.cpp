...
void Weapon::prePhysUpdate(const b2Vec2& center, const b2Vec2& aim, float32 angle, b2Body* pBody)//we are checking whether we should take a shot
{
    m_pBody = pBody;
...
void Weapon::postPhysUpdate(const b2Vec2& center, const b2Vec2& aim, float32 angle, b2Body* pBody)//we are determining our next shot
{
    m_pBody = pBody;
